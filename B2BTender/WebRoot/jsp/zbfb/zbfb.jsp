...
<div id="all">
    <div id="menu">
        <ul>
            <li><img src="<%=basePath %>jsp/frame/images/li.jpg" />&nbsp;&nbsp;&nbsp; <a href="" target="main">招标信息</a></li>
            <li><img src="<%=basePath %>jsp/frame/images/li.jpg" />&nbsp;&nbsp;&nbsp; <a href="" target="main">物资信息</a></li>
            <li><img src="<%=basePath %>jsp/frame/images/li.jpg" />&nbsp;&nbsp;&nbsp; <a href="" target="main">联系人信息</a></li>
        </ul>
    </div>
</div>
</body>

package com.bcsf.fzw.login.dao;
 ...
 * 
 * @see com.bcsf.fzw.login.model.TUser
...
public class TUserDAO extends HibernateDaoSupport {
	...
	public static final String UCTIME = "uctime";
	...
	public TUser findById(java.lang.Integer id) {
		...
		try {
			TUser instance = (TUser) getHibernateTemplate().get(
					"com.bcsf.fzw.login.model.TUser", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByUbirthday(Object ubirthday) {
	...
	public List findByUctime(Object uctime) {
		return findByProperty(UCTIME, uctime);
	}
